...
export const mockProducts: MockProduct[] = [
  ...
  },
  {
    ...
    subtitle: 'Sweet earthy hybrid with a euphoric kick',
    category: 'flower',
    strain: 'Hybrid',
    price: '$52.00',
    thc: '25%',
    ...
    image: PRODUCT_IMAGE,
    description:
      'GSC delivers a sweet, earthy aroma with notes of mint and chocolate, paired with a euphoric high that melts into full-body relaxation.',
    effects: ['Euphoric', 'Relaxed', 'Happy', 'Creative'],
    tags: ['dessert', 'hybrid', 'best-seller', 'top-shelf'],
    details: [
      'Dense, colorful nugs with orange hairs',
      'Sweet and earthy flavor profile',
      'Indoor grown with precise climate control',
      'Full panel lab tested',
    ],
    terpenes: [
      {name: 'Caryophyllene', color: 'bg-orange-400', pct: '0.38%'},
      {name: 'Limonene', color: 'bg-yellow-400', pct: '0.24%'},
      {name: 'Humulene', color: 'bg-lime-400', pct: '0.12%'},
    ],
    weights: [
      {label: '1g', price: '$16'},
      {label: '3.5g', price: '$52'},
  ...
  },
  {
    ...
    subtitle: 'Classic indica for deep evening relaxation',
    category: 'flower',
    strain: 'Indica',
    price: '$40.00',
    thc: '18%',
    ...
    image: PRODUCT_IMAGE,
    description:
      'One of the most famous indicas of all time, Northern Lights wraps you in a warm body high with sweet, piney undertones and a dreamy finish.',
    effects: ['Relaxed', 'Sleepy', 'Happy', 'Body High'],
    tags: ['classic', 'nighttime', 'sleep', 'indica'],
    details: [
      'Heritage genetics from the Pacific Northwest',
      'Resinous buds with a frosty finish',
      'Smooth smoke with minimal harshness',
      'Third-party lab tested',
    ],
    terpenes: [
      {name: 'Myrcene', color: 'bg-emerald-400', pct: '0.45%'},
      {name: 'Pinene', color: 'bg-sky-400', pct: '0.18%'},
      {name: 'Linalool', color: 'bg-violet-400', pct: '0.14%'},
    ],
    weights: [
      {label: '1g', price: '$12'},
      {label: '3.5g', price: '$40'},
  ...
  },
  {
    ...
    handle: 'orange-bud',
    title: 'Orange Bud',
    subtitle: 'Citrus-forward hybrid with upbeat energy',
    category: 'flower',
    strain: 'Hybrid',
    price: '$38.00',
    thc: '19%',
    ...
    image: PRODUCT_IMAGE,
    description:
      'Orange Bud lives up to its name with bright citrus flavor, a gentle mood lift, and an easy come-down that keeps things functional.',
    effects: ['Happy', 'Uplifted', 'Social', 'Creative'],
    tags: ['citrus', 'balanced', 'social', 'daytime'],
    details: [
      'Vibrant orange pistils throughout',
      'Sweet citrus aroma with earthy base',
      'Even burn and smooth draw',
      'Potency and purity lab verified',
    ],
    terpenes: [
      {name: 'Limonene', color: 'bg-yellow-400', pct: '0.34%'},
      {name: 'Myrcene', color: 'bg-emerald-400', pct: '0.19%'},
      {name: 'Pinene', color: 'bg-sky-400', pct: '0.11%'},
    ],
    weights: [
      {label: '1g', price: '$12'},
      {label: '3.5g', price: '$38'},
  ...
  },
  {
    ...
    handle: 'amnesia-haze',
    title: 'Amnesia Haze',
    subtitle: 'Hazy sativa with a psychedelic edge',
    category: 'flower',
    strain: 'Sativa',
    price: '$52.00',
    thc: '24%',
    ...
    image: PRODUCT_IMAGE,
    description:
      'A world-famous sativa with a complex lemon-incense profile, trippy cerebral effects, and a long-lasting creative buzz.',
    effects: ['Energetic', 'Creative', 'Euphoric', 'Focused'],
    tags: ['sativa', 'daytime', 'creative', 'top-shelf'],
    details: [
      'Award-winning genetics',
      'Complex terpene profile',
      'Long-lasting effects',
      'Full cannabinoid panel tested',
    ],
    terpenes: [
      {name: 'Terpinolene', color: 'bg-amber-400', pct: '0.28%'},
      {name: 'Limonene', color: 'bg-yellow-400', pct: '0.22%'},
      {name: 'Myrcene', color: 'bg-emerald-400', pct: '0.15%'},
    ],
    weights: [
      {label: '1g', price: '$16'},
      {label: '3.5g', price: '$52'},
  ...
  },
  {
    ...
    handle: 'og-kush',
    title: 'OG Kush',
    subtitle: 'The iconic hybrid with fuel and pine',
    category: 'flower',
    strain: 'Hybrid',
    price: '$64.99',
    ...
    image: PRODUCT_IMAGE,
    description:
      'The gold standard of cannabis. OG Kush delivers a complex mix of fuel, skunk, and spice that hits hard and stays heavy with a legendary euphoric lift.',
    effects: ['Euphoric', 'Relaxed', 'Heavy', 'Happy'],
    tags: ['classic', 'top-shelf', 'best-seller', 'gassy'],
    details: [
      'Hand-trimmed top-shelf flower',
      'Iconic fuel-forward terpene profile',
      'Small batch for quality control',
      'Full panel lab tested for potency and contaminants',
    ],
    terpenes: [
      {name: 'Myrcene', color: 'bg-emerald-400', pct: '0.38%'},
      {name: 'Limonene', color: 'bg-yellow-400', pct: '0.27%'},
      {name: 'Caryophyllene', color: 'bg-orange-400', pct: '0.21%'},
    ],
    weights: [
      {label: '1g', price: '$19'},
      {label: '3.5g', price: '$65'},
