        ...
        <style
          dangerouslySetInnerHTML={{
            __html:
              ...
              '.gigi-logo,.gigi-header__logo,.gigi-cl-logo,.gigi-pk-logo,.gigi-about-logo,.gigi-book-logo,.gigi-pd-logo,.gigi-pf-logo,.gigi-shop-logo{display:block;width:clamp(7rem,11vw,12rem)}' +
              '.gigi-logo img,.gigi-header__logo img,.gigi-cl-logo img,.gigi-pk-logo img,.gigi-about-logo img,.gigi-book-logo img,.gigi-pd-logo img,.gigi-pf-logo img,.gigi-shop-logo img{width:100%;height:auto}',
          }}
        />
